...
- [x] **PM3-5 — Documentation and verification**
  ...
  - Evidence: commits `ab623c54` (design), `239d4da6` (documentation of the five gaps), `977bd67b` (correction of the falsified narrow-mode sentence plus the link to the declaration loop) and `0d0b5ba1` (this closure).
