...
## Next decision
PM3-4 is closed. PM3-5 (documentation and verification of the whole rendering unit) is the last stage of this unit and needs an explicit go-ahead before it starts; the loop is now closed end to end, so its documentation half is mostly a consolidation pass. Commit, push, and PR remain separate decisions and require explicit authorization.
