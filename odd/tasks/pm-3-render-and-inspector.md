...
## Next decision
PM3-4 is authorized and in progress: the user gave the go-ahead and decided its grammar (`set`). PM3-5 (documentation and verification of the unit) is the last stage and needs its own go-ahead. Commit, push, and PR remain separate decisions and require explicit authorization.
